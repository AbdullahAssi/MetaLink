    ...
    return (
            <div className="Hero_container">
                ...
                <div className='hero_heading'>
                    ...
                    <p className='w-full lg:w-3/4 text-2xl lg:text-4xl my-10 px-0 lg:px-15 '>We are a huge marketplace dedicated to connecting great artists of all Metalink with their fans and unique token collectors!</p>
